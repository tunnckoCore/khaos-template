# {{default name basename}} [![npmjs.com][npmjs-img]][npmjs-url] [![The MIT License][license-img]][license-url] 
...
[Charlike Make Reagent](http://j.mp/1stW47C "#charlike {{date date 'MMMM DD YYYY'}}")
